...
function stringifyPatterns(settings) {
    ...
    if (!settings)
        return settings;
    const patterns = (_a = settings.patterns) === null || _a === void 0 ? void 0 : _a.map(pat => (Object.assign(Object.assign({}, pat), { pattern: pat.pattern.toString() })));
    return Object.assign(Object.assign({}, settings), { patterns });
}
