...
exports.regExSpellingGuardLine = exports.regExSpellingGuardNext = exports.regExSpellingGuardBlock = void 0;
...
exports.regExSpellingGuardNext = /\bc?spell(?:-?checker)?::?\s*disable-next\b.*\s.*/gi;
...
const overRideDefaults = {
    ...
    patterns: [
        ...
        },
        {
            ...
            pattern: exports.regExSpellingGuardBlock,
        },
        {
            name: 'SpellCheckerDisableNext',
            pattern: exports.regExSpellingGuardNext,
        },
        {
            name: 'SpellCheckerDisableLine',
            pattern: exports.regExSpellingGuardLine,
        },
    ],
    ignoreRegExpList: [
...
const defaultSettings = Object.assign(Object.assign({}, CSpell.mergeSettings(cspell_lib_2.getDefaultSettings(), CSpell.getGlobalSettings(), overRideDefaults)), { checkLimit: defaultCheckLimit, enabled: false });
...
function run() {
    ...
    async function handleMatchPatternsInDocument(params) {
        ...
        const settings = Object.assign({ patterns: [] }, docSettings);
        ...
        function mapResult(r) {
            const { name, elapsedTimeMs, message, regexp, ranges } = Object.assign(Object.assign({}, emptyResult), r);
            return {
                name,
        ...
        if (!validationByDoc.has(doc.uri)) {
            ...
            if (documentSettings_1.isUriBlackListed(uri)) {
                ...
                validationByDoc.set(doc.uri, validationRequestStream.pipe(operators_1.filter(doc => uri === doc.uri), operators_1.tap(doc => log_1.log(`Request Validate: v${doc.version}`, doc.uri)), operators_1.flatMap(async (doc) => ({ doc, settings: await getActiveSettings(doc) })), operators_1.debounce(dsp => rxjs_1.timer(dsp.settings.spellCheckDelayMs || defaultDebounce)
                    .pipe(operators_1.filter(() => !isValidationBusy))), operators_1.filter(dsp => !blockValidation.has(dsp.doc.uri)), operators_1.flatMap(validateTextDocument)).subscribe(diag => connection.sendDiagnostics(diag)));
            }
        }
    });
